 ...
 * This file demonstrates how to integrate Mirthxeno with a web frontend
 */

// For React/Vue/Angular applications
export class MirthxenoClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new MirthxenoClient(provider, contractAddress);
